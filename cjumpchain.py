...
def UnconditionalTransitionProbability(event, current_state_of_cond_jump_chain, sigma):
    ...
    set_of_events = set(['s_bb', 's_tt', 's_bt', 'm_1','m_2','s_b_arrow_t'])
    ...
    dictionary_event_to_instantaneous_rate = {'s_bb': 1.0, 's_tt': 1.0, 's_bt': 1.0,'s_b_arrow_t': 1.0,'m_1':1.0, 'm_2':1.0}
    ...
    dictionary_event_to_function = {'s_tt': UncondProbSTT, 's_bb': UncondProbSBB, 's_b_arrow_t': UncondProbSBarrowT, 's_bt': UncondProbSBT, 'm_1':UncondProbM1, 'm_2':UncondProbM2}
    ...
    for e in set_of_events:
        ...
        # Notice that it is good that all four of the above
    ...
    #print "dictionary_event_to_instantaneous_rate is: " + str(dictionary_event_to_instantaneous_rate[event])
    #print "sum_of_rates is: " + str(sum_of_rates)
...
if __name__ == "__main__":
    print str(5e-009 / .800799241298)
    current_state_of_cond_jump_chain = [1,1,0,1]
    sigma = [.01, .1, 2000, .05, .1]
    print ""
    print "Test case for level=3"
    print "---------------------------"
    state_space_at_current_level = GetCondJumpChainStateSpace(3)
    print "Given state_space: " + str(state_space_at_current_level)
    print "------------------"
    (A,b) = GetLinearEquations(state_space_at_current_level, sigma)
    #print "b is: " + str((A,b))
    print "The P(F|z) array is: " + str(LinearEquationSolver(A,b))  
